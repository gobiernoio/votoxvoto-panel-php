...
<?php include("aside.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h2>
        Votos Zona <?php echo $zona; ?> <span style="font-weight: lighter;"> del <?php echo $distrito; ?> - <?php echo $cabecera; ?></span>
      </h2>

      <h3>
        | 
        <?php
        $query_casillas = "SELECT DISTINCT casilla FROM votoxvoto WHERE zona = '$zona'";
        $result_casillas = mysql_query($query_casillas);
        while ( $row = mysql_fetch_assoc($result_casillas) ) { ?>

            <a href="casilla.php?casilla=<?php echo $row['casilla']; ?>&zona=<?php echo $zona; ?>&distrito=<?php echo $distrito; ?>&cabecera=<?php echo $cabecera; ?>">Casilla <?php echo $row['casilla']; ?></a> | 
      ...
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="box"><div class="box-header with-border">
                ...
                <b>Conteo de Votos Zona <?php echo $zona; ?></b> - <?php echo $distrito; ?>.- <?php echo $cabecera; ?></b>
                </h3>
                ...
                <table class="table table-bordered table-hover" style="margin-bottom: 45px;">
                  ...
                  <?php
                    ...
                    $consulta = "SELECT 
                                ...
                                SUM(es) as estotal
                                FROM votoxvoto WHERE zona = '$zona'";
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                ...
                <h3 class="box-title"><b>Gráfica de Votos de la Zona <?php echo $zona; ?></b> - <?php echo $distrito; ?>.- <?php echo $cabecera; ?></h3>
