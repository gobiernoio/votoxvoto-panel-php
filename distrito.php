...
<?php include("aside.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Votos <?php echo $_GET['distrito']; ?> - <?php echo $_GET['cabecera']; ?>
      </h1>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="box"><div class="box-header with-border">
                ...
                <b>Conteo de Votos <?php echo $_GET['distrito']; ?> - <?php echo $_GET['cabecera']; ?></b>
                </h3>
                ...
                <table class="table table-bordered table-hover" style="margin-bottom: 45px;">
                  ...
                  <?php
                    ...
                    $consulta = "SELECT 
                                ...
                                SUM(es) as estotal
                                FROM votoxvoto WHERE distrito = '$distrito'";
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                ...
                <h3 class="box-title">Gráfica de Votos del <?php echo $_GET['distrito']; ?> - <?php echo $_GET['cabecera']; ?></h3>
